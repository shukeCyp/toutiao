  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <div class="nav-section">
        ...
        <router-link to="/account-profiles" class="nav-item" :class="{ active: $route.path === '/account-profiles' }">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
        ...
        <router-link to="/account-list" class="nav-item" :class="{ active: $route.path === '/account-list' }">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
